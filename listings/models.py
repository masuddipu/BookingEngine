...
class BookingData(models.Model):
    ...
    listing = models.ForeignKey(Listing, on_delete=models.CASCADE, blank=True, null=True, related_name='booking_data')
    hotel_room = models.ForeignKey(HotelRoom, on_delete=models.CASCADE, blank=True, null=True, related_name='booking_data')
